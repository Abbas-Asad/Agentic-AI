...
class GuardrailFunctionOutput:
    ...
    output_info: Any        # how it'll be optional?
    """
...
class InputGuardrail(Generic[TContext]):
    ...
    async def run(
        ...
        # print("\noutput: ", output)  # 2 properties: LLM guardrail agent response & trigger boolean value
        ...
        input_guardrail_result = InputGuardrailResult(
            guardrail=self,
            output=output,
        )
        print("\ninput_guardrail_result in guardrail:", input_guardrail_result)  # InputGuardrailResult may sab kuch hota hai
